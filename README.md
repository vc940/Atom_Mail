...
| ✍️ Smart Compose & Rewrite | Compose new emails or rewrite drafts in professional, friendly, or concise tone |
| 🛡️ Privacy First | A custom model is used to **automatically detect and mask sensitive information** (e.g., bank details, OTP's, personal id no's) before processing
